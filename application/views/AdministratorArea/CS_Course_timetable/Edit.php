...
$configurations = array(
    ...
    "PAGE_TITLE" => "CS_COURSE TIMETABLE",

    "PAGE_HEADER" => array(

        "MAIN_TITLE" => "CS_COURSE TIMETABLE",
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar1">
                                                                        ...
                                                                        if (isset($cs->image) && $cs->image != "" && file_exists(FCPATH . '/assets/uploads/cs_course_timetable/' . $cs->image)) {

                                                                            $image = uploadsDirectory("cs_course_timetable/" . $cs->image);
                                                                        }
