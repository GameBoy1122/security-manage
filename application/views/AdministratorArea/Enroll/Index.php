                        ...
                        <div class="kt-portlet kt-faq-v1">
                            ...
                            <div class="kt-portlet__head  kt-iconbox kt-iconbox--brand kt-iconbox--animate-slow">
                                ...
                                ?>
                                    ...
                                    <div class="kt-portlet__head-toolbar" hidden>

                                        <div class="kt-portlet__head-wrapper">

                                            <a href="<?php echo base_url('AdministratorArea/Enroll/edit'); ?>">
        ...
        var demo = function() {
            ...
            var datatable = $('.kt-datatable').KTDatatable({
                ...
                data: {
                    ...
                    source: '<?php echo base_url('AdministratorArea/Enroll/datatables'); ?>',
                ...
                columns: [
...

                    {
                        ...
                        template: function(row) {
                            ...
                            var db_id = row['enroll_id'];

                            var action_header = '<a href="<?php echo base_url('Genpdf/mpdf/'); ?>' + db_id + '"class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Edit details">' +
                            ...
                            action_header += '<a class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Delete" id="confirmDelete' + db_id + '">' +
                                ...
                                '<input type="hidden" id="' + db_id + '" value="<?php echo base_url('AdministratorArea/Enroll/delete/'); ?>' + db_id + '">';
