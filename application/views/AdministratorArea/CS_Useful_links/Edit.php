...
$configurations = array(
    ...
    "PAGE_TITLE" => "CS_USEFUL LINKS",

    "PAGE_HEADER" => array(

        "MAIN_TITLE" => "CS_USEFUL LINKS",
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar1">
                                                                        ...
                                                                        if (isset($cs->image) && $cs->image != "" && file_exists(FCPATH . '/assets/uploads/cs_useful_links/' . $cs->image)) {

                                                                            $image = uploadsDirectory("cs_useful_links/" . $cs->image);
                                                                        }
