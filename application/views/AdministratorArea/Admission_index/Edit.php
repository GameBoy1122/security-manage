...
$configurations = array(
    ...
    "PAGE_TITLE" => "Admission_index",

    "PAGE_HEADER" => array(

        "MAIN_TITLE" => "Admission_index",
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar1">
                                                                        ...
                                                                        if (isset($admission->image) && $admission->image != "" && file_exists(FCPATH . '/assets/uploads/admission_index/' . $admission->image)) {

                                                                            $image = uploadsDirectory("admission_index/" . $admission->image);
                                                                        }
            ...
            $("#main-form").validate({
                ...
                submitHandler: function() {
                    ...
                    $.ajax({
                        ...
                        // url: "<?php echo base_url("Admin/Admission_index/edit") ?>",
