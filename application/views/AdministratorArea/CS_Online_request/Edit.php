...
$configurations = array(
    ...
    "PAGE_TITLE" => "CS_ONLINE REQUEST",

    "PAGE_HEADER" => array(

        "MAIN_TITLE" => "CS_ONLINE REQUEST",
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar1">
                                                                        ...
                                                                        if (isset($cs->image) && $cs->image != "" && file_exists(FCPATH . '/assets/uploads/cs_online_request/' . $cs->image)) {

                                                                            $image = uploadsDirectory("cs_online_request/" . $cs->image);
                                                                        }
