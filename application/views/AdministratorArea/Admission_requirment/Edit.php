...
$configurations = array(
    ...
    "PAGE_TITLE" => "Admission_requirment",

    "PAGE_HEADER" => array(

        "MAIN_TITLE" => "Admission_requirment",
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar1">
                                                                        ...
                                                                        if (isset($admission->image) && $admission->image != "" && file_exists(FCPATH . '/assets/uploads/admission_requirment/' . $admission->image)) {

                                                                            $image = uploadsDirectory("admission/" . $admission->image);
                                                                        }
