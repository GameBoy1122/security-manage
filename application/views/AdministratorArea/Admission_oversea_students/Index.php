                            ...
                            <?php if (checkAdministratorPermission("ADMINISTRATOR_MANAGEMENT", "index")) {
                                ...
                                <div class="kt-portlet__head-toolbar">
                                    ...
                                    <div class="kt-portlet__head-wrapper">
                                        ...
                                        <a href="<?php echo base_url('AdministratorArea/admission_oversea_students/edit'); ?>">
    ...
    var demo = function() {
        ...
        var datatable = $('.kt-datatable').KTDatatable({
            ...
            data: {
                ...
                source: '<?php echo base_url('AdministratorArea/Admission_oversea_students/datatables'); ?>',
...

            {
                ...
                field: 'admission_oversea_students_id',
...

            {
                ...
                template: function(row) {
                    ...
                    var db_id = row['admission_oversea_students_id'];

                    var action_header = '<a href="<?php echo base_url('AdministratorArea/Admission_oversea_students/edit/');?>'+db_id+'"class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Edit details">'+
                    ...
                    action_header += '<a class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Delete" id="confirmDelete'+db_id+'">'+
                        ...
                        '<input type="hidden" id="'+db_id+'" value="<?php echo base_url('AdministratorArea/Admission_oversea_students/delete/');?>'+db_id+'">';
