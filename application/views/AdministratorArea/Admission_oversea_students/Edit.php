...
$configurations = array(
    ...
    "PAGE_TITLE" => "Admission_oversea_students",

    "PAGE_HEADER" => array(

        "MAIN_TITLE" => "Admission_oversea_students",
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar1">
                                                                        ...
                                                                        if (isset($admission->image) && $admission->image != "" && file_exists(FCPATH . '/assets/uploads/admission_oversea_students/' . $admission->image)) {

                                                                            $image = uploadsDirectory("admission_oversea_students/" . $admission->image);
                                                                        }
