...
$configurations = array(
    ...
    "PAGE_TITLE" => "Admission_application_period",

    "PAGE_HEADER" => array(

        "MAIN_TITLE" => "Admission_application_period",
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="kt-radio-inline">
                                                        ...
                                                        <label class="kt-radio kt-radio--bold kt-radio--success">
                                                            ...
                                                            <input type="radio" name="status" value="ACTIVATE" <?php if (!isset($admission->status) || $admission->status == "ACTIVATE") echo "checked" ?>> Activate
                                                        ...
                                                        <label class="kt-radio kt-radio--bold kt-radio--warning">
                                                            ...
                                                            <input type="radio" name="status" value="SUSPEND" <?php if (isset($admission->status) && $admission->status != "ACTIVATE") echo "checked" ?>> Suspend
                                                    ...
                                                    <div class="kt-wizard-v3__form">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar1">
                                                                        ...
                                                                        if (isset($admission->image) && $admission->image != "" && file_exists(FCPATH . '/assets/uploads/admission_application_period/' . $admission->image)) {

                                                                            $image = uploadsDirectory("admission_application_period/" . $admission->image);
                                                                        }

                                                                        ?>

                                                                        <div class="kt-avatar__holder" <?php if (isset($admission->image)) echo ' style="background-image:url(' . $image . ');"'; ?>> </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-6 col-xl-7">
                                                                ...
                                                                <input type="text" class="form-control" name="title" value="<?php if (isset($admission->title)) echo $admission->title ?>">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-6 col-xl-7">
                                                                ...
                                                                <!-- <textarea class="ckeditor form-control" name="description" rows="6" data-error-container="#editor2_error" value="<?php if (isset($admission->description)) echo $admission->description ?>"></textarea>
                                                                <div id="editor2_error"> </div> -->
                                                                <textarea class="summernote" id="description" name="description"><?php if (isset($admission->description)) echo $admission->description; ?></textarea>
