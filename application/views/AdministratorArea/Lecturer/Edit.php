                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="kt-radio-inline">
                                                        ...
                                                        <label class="kt-radio kt-radio--bold kt-radio--success">
                                                            ...
                                                            <input type="radio" name="status" value="ACTIVATE" <?php if (!isset($Lecturer->status) || $Lecturer->status == "ACTIVATE") echo "checked" ?>> Activate
                                                        ...
                                                        <label class="kt-radio kt-radio--bold kt-radio--warning">
                                                            ...
                                                            <input type="radio" name="status" value="SUSPEND" <?php if (isset($Lecturer->status) && $Lecturer->status != "ACTIVATE") echo "checked" ?>> Suspend
                                                    ...
                                                    <div class="kt-wizard-v3__form">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    ...
                                                                    <div class="kt-avatar kt-avatar--outline" id="kt_user_add_avatar1">
                                                                        ...
                                                                        if (isset($Lecturer->image) && $Lecturer->image != "" && file_exists(FCPATH . $Lecturer->image)) {

                                                                            $image = base_url('' . $Lecturer->image);
                                                                        }

                                                                        ?>

                                                                        <div class="kt-avatar__holder" <?php if (isset($Lecturer->image)) echo ' style="background-image:url(' . $image . ');"'; ?>> </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-6 col-xl-7">
                                                                ...
                                                                <input type="text" class="form-control" name="name" value="<?php if (isset($Lecturer->name)) echo $Lecturer->name ?>">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-6 col-xl-7">
                                                                <textarea class="summernote" id="position" name="position">"<?php if (isset($Lecturer->position)) echo $Lecturer->position ?></textarea>
                                                                <!-- <input type="text" class="form-control" name="position" value="<?php if (isset($Lecturer->position)) echo $Lecturer->position ?>"> -->
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-6 col-xl-7">
                                                                ...
                                                                <input type="text" class="form-control" name="sort" value="<?php if (isset($Lecturer->sort)) echo $Lecturer->sort ?>">
