                                                    ...
                                                    <div class="kt-wizard-v3__form">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-6 col-xl-7">
                                                                <textarea class="summernote" id="location" name="address"><?php if (isset($Contact_us->address))
                                                                                                                                    echo $Contact_us->address ?></textarea>
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <label class="col-lg-3 col-form-label" align="right">Opening
                                                                time</label>

                                                            <div class="col-lg-6 col-xl-7">

                                                                <input type="text" class="form-control" name="time" value="<?php if (isset($Contact_us->time))
                                                                                                                                    echo $Contact_us->time ?>">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <label class="col-lg-3 col-form-label" align="right">Linkedin </label>

                                                            <div class="col-lg-6 col-xl-7">

                                                                <input type="text" class="form-control" name="linkedin" value="<?php if (isset($Contact_us->linkedin))
                                                                                                                                    echo $Contact_us->linkedin ?>">
