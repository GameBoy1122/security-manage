...
class Admission_requirment extends CI_Controller

{
...

	{
        ...
        $this->load->model("Admission_requirment_model");
        ...
        $page = $this->Admission_requirment_model->search($page);



        $this->load->view("AdministratorArea/Admission_requirment/Index", compact("page"));

	}



    public function page($admission_requirment_id = null)

    {
...

        {
            ...
            if($admission_requirment_id != null)

            {

                $page = $this->admission_requirment_model->find($admission_requirment_id);
...

            {
                ...
                $admission_requirment_id = $this->admission_requirment_model->save($page);
        ...
        $this->load->view("AdministratorArea/Admission_requirment/Page",$data);

    }



	public function edit($admission_requirment_id = null)

	{
        ...
        $admission_requirments = $this->admission_requirment_model->search();
...

        {
...

            {
                ...
                $admission = $this->admission_requirment_model->find($admission_requirment_id);
            ...
            $admission_requirment_validated = array("code" => "0x0000-00000", "message" => "Server response success. Request process complete with no error.");

            if($admission_requirment_validated["code"] == "0x0000-00000")

            {

                $admission_requirment_id = $this->admission_requirment_model->save($admission);
                $this->response_library->responseJSON($admission_requirment_validated["code"], $admission_requirment_validated["message"]);
        ...
        $this->load->view("AdministratorArea/Admission_requirment/Edit",$data);

	}



    public function delete($admission_requirment_id = null)

    {
...

        {
            ...
            $this->admission_requirment_model->save($admission);
...

    {
            ...
            $admission = $this->admission_requirment_model->search($model_filter);
