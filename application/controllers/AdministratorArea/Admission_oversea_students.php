...
class Admission_oversea_students extends CI_Controller

{
...

	{
        ...
        $this->load->model("Admission_oversea_students_model");
        ...
        $page = $this->Admission_oversea_students_model->search($page);



        $this->load->view("AdministratorArea/Admission_oversea_students/Index", compact("page"));
	...
	public function edit($admission_oversea_students_id = null)

	{
        ...
        $admission_oversea_studentss = $this->admission_oversea_students_model->search();
...

        {
            ...
            if($admission_oversea_students_id != null)

            {

                $admission = $this->admission_oversea_students_model->find($admission_oversea_students_id);
            ...
            $admission_oversea_students_validated = array("code" => "0x0000-00000", "message" => "Server response success. Request process complete with no error.");

            if($admission_oversea_students_validated["code"] == "0x0000-00000")

            {

                $admission_oversea_students_id = $this->admission_oversea_students_model->save($admission);
                $this->response_library->responseJSON($admission_oversea_students_validated["code"], $admission_oversea_students_validated["message"]);
        ...
        $this->load->view("AdministratorArea/Admission_oversea_students/Edit",$data);

	}



    public function delete($admission_oversea_students_id = null)

    {
...

        {
            ...
            $this->admission_oversea_students_model->save($admission);
...

    {
            ...
            $admission = $this->admission_oversea_students_model->search($model_filter);
