...
class Admission_scholarship extends CI_Controller

{
...

	{
        ...
        $this->load->model("Admission_scholarship_model");
        ...
        $page = $this->Admission_scholarship_model->search($page);



        $this->load->view("AdministratorArea/Admission_scholarship/Index", compact("page"));
	...
	public function edit($admission_scholarship_id = null)

	{
        ...
        $admission_scholarships = $this->admission_scholarship_model->search();
...

        {
            ...
            if($admission_scholarship_id != null)

            {

                $admission = $this->admission_scholarship_model->find($admission_scholarship_id);
            ...
            $admission_scholarship_validated = array("code" => "0x0000-00000", "message" => "Server response success. Request process complete with no error.");

            if($admission_scholarship_validated["code"] == "0x0000-00000")

            {

                $admission_scholarship_id = $this->admission_scholarship_model->save($admission);
                $this->response_library->responseJSON($admission_scholarship_validated["code"], $admission_scholarship_validated["message"]);
        ...
        $this->load->view("AdministratorArea/Admission_scholarship/Edit",$data);

	}



    public function delete($admission_scholarship_id = null)

    {
...

        {
            ...
            $this->admission_scholarship_model->save($admission);
...

    {
            ...
            $admission = $this->admission_scholarship_model->search($model_filter);
