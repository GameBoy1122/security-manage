...
class Admission_application_period extends CI_Controller

{
...

	{
        ...
        $this->load->model("Admission_application_period_model");
        ...
        $page = $this->Admission_application_period_model->search($page);



        $this->load->view("AdministratorArea/Admission_application_period/Index", compact("page"));

	}



    public function page($admission_application_period_id = null)

    {
...

        {
            ...
            if($admission_application_period_id != null)

            {

                $page = $this->admission_application_period_model->find($admission_application_period_id);
...

            {
                ...
                $admission_application_period_id = $this->admission_application_period_model->save($page);
        ...
        $this->load->view("AdministratorArea/Admission_application_period/Page",$data);

    }



	public function edit($admission_application_period_id = null)

	{
        ...
        $admission_application_periods = $this->admission_application_period_model->search();
...

        {
...

            {
                ...
                $admission = $this->admission_application_period_model->find($admission_application_period_id);
            ...
            $admission_application_period_validated = array("code" => "0x0000-00000", "message" => "Server response success. Request process complete with no error.");

            if($admission_application_period_validated["code"] == "0x0000-00000")

            {

                $admission_application_period_id = $this->admission_application_period_model->save($admission);
                $this->response_library->responseJSON($admission_application_period_validated["code"], $admission_application_period_validated["message"]);
        ...
        $this->load->view("AdministratorArea/Admission_application_period/Edit",$data);

	}



    public function delete($admission_application_period_id = null)

    {
...

        {
            ...
            $this->admission_application_period_model->save($admission);
...

    {
            ...
            $admission = $this->admission_application_period_model->search($model_filter);
