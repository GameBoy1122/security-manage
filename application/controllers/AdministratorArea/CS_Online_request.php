...
class CS_Online_request extends CI_Controller

{
...

	{
        ...
        $this->load->model("CS_Online_request_model");
        ...
        $page = $this->CS_Online_request_model->search($page);



        $this->load->view("AdministratorArea/CS_Online_request/Index", compact("page"));

	}

	public function edit($cs_online_request_id = null)

	{
        ...
        $cs_online_requests = $this->cs_online_request_model->search();
...

        {
            ...
            if($cs_online_request_id != null)

            {

                $cs = $this->cs_online_request_model->find($cs_online_request_id);
...

            {
                ...
                $config['upload_path'] = FCPATH.'/assets/uploads/cs_online_request/';
            ...
            $cs_online_request_validated = array("code" => "0x0000-00000", "message" => "Server response success. Request process complete with no error.");

            if($cs_online_request_validated["code"] == "0x0000-00000")

            {

                $cs_online_request_id = $this->cs_online_request_model->save($cs);
                $this->response_library->responseJSON($cs_online_request_validated["code"], $cs_online_request_validated["message"]);
        ...
        $this->load->view("AdministratorArea/CS_Online_request/Edit",$data);

	}



    public function delete($cs_online_request_id = null)

    {
...

        {
            ...
            $this->cs_online_request_model->save($cs);
...

    {
            ...
            $cs = $this->cs_online_request_model->search($model_filter);
