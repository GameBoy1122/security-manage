...
class CS_Useful_links extends CI_Controller

{
...

	{
        ...
        $this->load->model("CS_Useful_links_model");
        ...
        $page = $this->CS_Useful_links_model->search($page);



        $this->load->view("AdministratorArea/CS_Useful_links/Index", compact("page"));

	}

	public function edit($cs_useful_links_id = null)

	{
        ...
        $cs_useful_linkss = $this->cs_useful_links_model->search();
...

        {
            ...
            if($cs_useful_links_id != null)

            {

                $cs = $this->cs_useful_links_model->find($cs_useful_links_id);
...

            {
                ...
                $config['upload_path'] = FCPATH.'/assets/uploads/cs_useful_links/';
            ...
            $cs_useful_links_validated = array("code" => "0x0000-00000", "message" => "Server response success. Request process complete with no error.");

            if($cs_useful_links_validated["code"] == "0x0000-00000")

            {

                $cs_useful_links_id = $this->cs_useful_links_model->save($cs);
                $this->response_library->responseJSON($cs_useful_links_validated["code"], $cs_useful_links_validated["message"]);
        ...
        $this->load->view("AdministratorArea/CS_Useful_links/Edit",$data);

	}



    public function delete($cs_useful_links_id = null)

    {
...

        {
            ...
            $this->cs_useful_links_model->save($cs);
...

    {
            ...
            $cs = $this->cs_useful_links_model->search($model_filter);
