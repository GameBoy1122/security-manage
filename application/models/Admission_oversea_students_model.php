...
class Admission_oversea_students_model extends CI_Model

{
    ...
    private $table_name = "admission_oversea_students";

    private $table_primary_key = "admission_oversea_students_id";
