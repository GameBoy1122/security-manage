...
class Admission_application_period_model extends CI_Model

{
    ...
    private $table_name = "admission_application_period";

    private $table_primary_key = "admission_application_period_id";
