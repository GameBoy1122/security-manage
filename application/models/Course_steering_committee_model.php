...
class Course_steering_committee_model extends CI_Model

{
    ...
    private $table_name = "course_steering_committee";

    private $table_primary_key = "course_steering_committee_id";
